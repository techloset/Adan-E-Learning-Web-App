...
const Feature = () => {
    return (
        <div className=' mt-20 '>
            ...
            {/* Cards */}
            {/* Card One */}
            <div className=' 2xl:w-[80%] xl:w-[90%] mx-auto'>
                <div className="flex flex-col lg:flex-row items-center justify-center pt-8 2xl:gap-20 sm:gap-2">
                    ...
                    <div className="lg:w-1/2 2xl:w-[auto] xl:w-2/3  md:w-full sm:w-full xs:w-full flex flex-col justify-center items-center ">
                        <h1 className='2xl:text-[40px] xl:text-[40px] text-[30px] font-[600] leading-[160%]  text-[#2F327D] 2xl:w-[542px]'>A <span className='text-[#00CBB8]'>user interface</span> designed for the classroom</h1>
            ...
            {/* Card Two */}
            <div className='mt-20 grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 gap-10 justify-between items-center   2xl:w-[80%]  xl:w-[85%]  lg:w-[85%]  md:w-[90%]  sm:w-[98%]  xs:w-[98%%]  mx-auto'>
                <div className='flex flex-col relative md:justify-center '>
                    ...
                    <div className='space-y-4 relative md:mx-auto xs:mx-auto 2xl:mx-0'>
                ...
                <div>
                    <Image
                        src="/homepage/Feature/CardTwo/Girl.png"
                        alt='Pic'
                        width={1000}
                        height={1000} /></div>
            </div>
            ...
            <div className='mt-20 grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 gap-10 justify-between items-center  mx-auto 2xl:w-[80%]  xl:w-[85%]  lg:w-[85%]  md:w-[90%]  sm:w-[98%]  xs:w-[98%%]  '>
                <div className='flex flex-col relative md:justify-center space-y-4  md:mx-auto xs:mx-auto 2xl:mx-0'>
            ...
            {/* Button */}
            <div className='mt-20 mb-10 flex flex-col justify-center items-center text-center  font-nunito-sans'>
