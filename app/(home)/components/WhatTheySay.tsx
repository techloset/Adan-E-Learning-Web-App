...
const WhatTheySay = () => {
    return (
        <div className='2xl:mt-72 sm:mt-40 xs:mt-20'>
            <div className='mt-20 grid 2xl:grid-cols-2 xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 gap-10 justify-between   mx-auto 2xl:w-[80%]  xl:w-[85%]  lg:w-[85%]  md:w-[90%]  sm:w-[98%]  xs:w-[98%%]  '>
                <div className='flex flex-col md:mx-auto xs:mx-auto 2xl:mx-0'>
                    <div className='flex gap-6  items-center'>
                        <hr className='border-[1px] border-[#525596] w-[80px]' /><h5 className='text-[#525596]  font-[400] leading-[normal] text-[20px] tracking-[4px] font-nunito-sans'>TESTIMONIAL</h5>
                    </div>
                ...
                <div className="md:mx-auto xs:mx-auto 2xl:mx-0">
                    <Image
