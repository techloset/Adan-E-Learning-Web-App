  ...
  return (
    <div className="p-4">
      <div className="flex">
        ...
        <div className='flex justify-center items-center max-w-[454px] w-auto mx-auto xs:mt-16 2xl:my-2 sm:mt-16  '>
        ...
        <div className='mt-6 2xl:w-[329px] xl:w-[329px] lg:w-[329px] md:w-[315px]  sm:w-[315px]  xs:w-[331px] h-[59px]  rounded-[33px] AuthLoginBlueBg flex items-center justify-between px-3 gap-1'>
        ...
        <h5 className='mt-[52px] pl-2 mx-2 flex items-center justify-center  text-[#5B5B5B] text-[16px] font-[400] leading-[normal] 2xl:w-[454px] xl:w-[454px] lg:w-[454px] md:w-[331px] xs:w-[331px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h5>
        {/* AuthForm */}
        <form className='mt-[42px] space-y-[30px]'>
          {variant == "REGISTER" && (
            <Input
              id="email"
              label="Email Address"
