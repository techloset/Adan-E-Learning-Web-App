...
const Dashboard = () => {
    return (
        <div className="mt-20">
            <h1 className="text-[#49BBBD] text-center md:text-[64px] sm:text-[30px] xs:text-[25px] font-[800] leading-[normal] tracking-[-1px]">Affordable pricing</h1>

            {/* Desktop */}
            <div className="lg:flex md:hidden sm:hidden xs:hidden w-[100%] justify-center items-center gap-3 mb-3">
