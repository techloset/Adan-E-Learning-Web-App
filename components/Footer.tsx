  ...
  return (
    <footer className=' bg-[#252641]'>
      ...
      <div className=' pt-6 flex 2xl:flex-row  xl:flex-row lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-8 mx-auto justify-center items-center'>
        ...
        />
        <button className='w-[179px]    h-[60px] flex items-center justify-center text-center text-[#fff] font-[500] leading-[normal] rounded-[60px] text-[22px] bg-[#49BBBD]'>Subscribe</button>
      </div>
