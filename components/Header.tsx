        ...
        <>
            <div className='mb-0 flex justify-between px-20 pt-8  xl:flex sm:hidden xs:hidden md:hidden bg-white'>
                ...
                <div className='flex items-center'>
                    <div>
                        <ul className='flex'>
                            <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[40px]  cursor-pointer'>Home</li>
                            <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[40px]  cursor-pointer'>Courses</li>
                            <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[40px]  cursor-pointer'>Careers</li>
                            <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[40px]  cursor-pointer'>Blog</li>
                            <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[60px]  cursor-pointer'>About Us</li>
                        </ul>
                    </div>
                ...
                <div className="justify-between px-5 mx-auto lg:max-w-7xl lg:items-center  lg:flex lg:px-8">
                    ...
                    <div>
                        ...
                        <ul className="items-center justify-center space-y-8 lg:flex lg:space-x-6 lg:space-y-0">
                                ...
                                <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[40px]  cursor-pointer'>Careers</li>
                                <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[40px]  cursor-pointer'>Blog</li>
                                <li className='text-[22px] font-[400] leading-[normal] tracking-[0.44px] text-[#5B5B5B] mr-[90px]  cursor-pointer'>About Us</li>
                            </ul>
                        </div>
